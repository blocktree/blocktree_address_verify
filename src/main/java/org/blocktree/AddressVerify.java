...
public class AddressVerify {
    public static boolean Verify(String coinTag, String Address, String Params) throws Exception {
        try {
            ...
            Object result = method.invoke(coinClass.newInstance(), Address, Params);
